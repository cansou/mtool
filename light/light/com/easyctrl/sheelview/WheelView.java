package com.easyctrl.sheelview;
...
public class WheelView extends View {
    ...
    private static final int ADDITIONAL_ITEM_HEIGHT = Integer.valueOf(MainApplication.mContext.getResources().getString(R.string.time_selector)).intValue();
    ...
    private static final int TEXT_SIZE = Integer.valueOf(MainApplication.mContext.getResources().getString(R.string.WheelView_TextSize)).intValue();
    ...
    private void createLayouts(int widthItems, int widthLabel) {
        ...
        if (this.itemsLayout == null || this.itemsLayout.getWidth() > widthItems) {
            ...
            this.itemsLayout = new StaticLayout(buildText, textPaint, widthItems, alignment, 1.0f, (float) ADDITIONAL_ITEM_HEIGHT, false);
        } else {
        ...
        if (!this.isScrollingPerformed && (this.valueLayout == null || this.valueLayout.getWidth() > widthItems)) {
            ...
            this.valueLayout = new StaticLayout(buildText, textPaint, widthItems, alignment, 1.0f, (float) ADDITIONAL_ITEM_HEIGHT, false);
        ...
        if (this.labelLayout == null || this.labelLayout.getWidth() > widthLabel) {
            this.labelLayout = new StaticLayout(this.label, this.valuePaint, widthLabel, Alignment.ALIGN_NORMAL, 1.0f, (float) ADDITIONAL_ITEM_HEIGHT, false);
        } else {
